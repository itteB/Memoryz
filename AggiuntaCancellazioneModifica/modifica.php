<?php
    ...
    echo '
      ...
      foreach ($xml as $personaggi => $personaggio) {
        if($personaggio->indice == $_GET['i']){
          echo'
           <input type="text" required name="ncompleto" value="'.$personaggio->n_completo.'" placeholder="Nome completo" class="input input-bordered input-primary w-full max-w-xs" /> <br> <br>';
          ...
          echo '<input type="file" name="img" class="file-input file-input-bordered file-input-primary w-full max-w-xs" /> <p> Aggiungere solamente se si vuole sostituire l immagine </p><br><div id="daqua">';
    ...
    <button type="button" class="btn btn-outline" onclick="sugg2()">Nuova soluzione</button>
